  ...
  return function i(o) {
    for (var r = e.querySelectorAll(t), s = o.target; s && s !== this; s = s.parentNode) {
      for (var a = r.length; a--;) {
        if (r[a] === s) return o.delegateTarget = s, i.oneOff && EventHandler.off(e, o.type, n), n.apply(s, [o]);
      }
    }
...
function addHandler(e, t, n, i, o) {
  if ("string" == typeof t && e) {
    ...
    if (c) c.oneOff = c.oneOff && o;else {
      ...
      d.delegationSelector = s ? n : null, d.originalHandler = a, d.oneOff = o, d.uidEvent = u, _[u] = d, e.addEventListener(l, d, s);
    }
  }
}
...
var EventHandler = {
  ...
  trigger: function trigger(e, t, n) {
    ...
    return s && o && (i = o.Event(t, n), o(e).trigger(i), l = !i.isPropagationStopped(), E = !i.isImmediatePropagationStopped(), _ = i.isDefaultPrevented()), a ? (c = document.createEvent("HTMLEvents")).initEvent(r, l, !0) : c = new CustomEvent(t, {
      bubbles: l,
      cancelable: !0
...
exports.Alert = Alert;
EventHandler.on(document, EVENT_CLICK_DATA_API, SELECTOR_DISMISS, Alert.handleDismiss(new Alert())), defineJQueryPlugin(NAME, Alert);
...
var Manipulator = {
  ...
  return n.next = function () {
    ...
    if (!(e <= SWIPE_THRESHOLD)) {
      ...
      this.touchDeltaX = 0, t > 0 && (isRTL ? this.next() : this.prev()), t < 0 && (isRTL ? this.prev() : this.next());
    }
    ...
    var e = this,
        t = function t(_t) {
      !e._pointerEvent || _t.pointerType !== POINTER_TYPE_PEN && _t.pointerType !== POINTER_TYPE_TOUCH ? e._pointerEvent || (e.touchStartX = _t.touches[0].clientX) : e.touchStartX = _t.clientX;
    },
        n = function n(t) {
      !e._pointerEvent || t.pointerType !== POINTER_TYPE_PEN && t.pointerType !== POINTER_TYPE_TOUCH || (e.touchDeltaX = t.clientX - e.touchStartX), e._handleSwipe(), "hover" === e._config.pause && (e.pause(), e.touchTimeout && clearTimeout(e.touchTimeout), e.touchTimeout = setTimeout(function (t) {
        return e.cycle(t);
    ...
    /input|textarea/i.test(e.target.tagName) || (e.key === ARROW_LEFT_KEY ? (e.preventDefault(), isRTL ? this.next() : this.prev()) : e.key === ARROW_RIGHT_KEY && (e.preventDefault(), isRTL ? this.prev() : this.next()));
    ...
    if (this._indicatorsElement) {
      ...
      for (var n = SelectorEngine.find(SELECTOR_INDICATOR, this._indicatorsElement), i = 0; i < n.length; i++) {
    ...
    if (r && r.classList.contains(CLASS_NAME_ACTIVE$1)) this._isSliding = !1;else if (!this._triggerSlideEvent(r, _).defaultPrevented && i && r) {
      if (this._isSliding = !0, a && this.pause(), this._setActiveIndicatorElement(r), this._activeElement = r, this._element.classList.contains(CLASS_NAME_SLIDE)) {
        ...
        EventHandler.one(i, "transitionend", function () {
          r.classList.remove(l, E), r.classList.add(CLASS_NAME_ACTIVE$1), i.classList.remove(CLASS_NAME_ACTIVE$1, E, l), n._isSliding = !1, setTimeout(function () {
      ...
      } else i.classList.remove(CLASS_NAME_ACTIVE$1), r.classList.add(CLASS_NAME_ACTIVE$1), this._isSliding = !1, EventHandler.trigger(this._element, EVENT_SLID, {
        relatedTarget: r,
        direction: _,
        from: o,
        to: s
  ...
  return n.toggle = function () {
    ...
    if (!this._isTransitioning && !this._element.classList.contains(CLASS_NAME_SHOW$1)) {
      ...
      if (!EventHandler.trigger(this._element, EVENT_SHOW).defaultPrevented) {
        ...
        this._element.classList.remove(CLASS_NAME_COLLAPSE), this._element.classList.add(CLASS_NAME_COLLAPSING), this._element.style[s] = 0, this._triggerArray.length && this._triggerArray.forEach(function (e) {
        ...
        EventHandler.one(this._element, "transitionend", function () {
          e._element.classList.remove(CLASS_NAME_COLLAPSING), e._element.classList.add(CLASS_NAME_COLLAPSE, CLASS_NAME_SHOW$1), e._element.style[s] = "", e.setTransitioning(!1), EventHandler.trigger(e._element, EVENT_SHOWN);
        }), emulateTransitionEnd(this._element, l), this._element.style[s] = this._element[a] + "px";
      }
    }
  }, n.hide = function () {
    var e = this;

    if (!this._isTransitioning && this._element.classList.contains(CLASS_NAME_SHOW$1) && !EventHandler.trigger(this._element, EVENT_HIDE).defaultPrevented) {
      var t = this._getDimension();

      this._element.style[t] = this._element.getBoundingClientRect()[t] + "px", reflow(this._element), this._element.classList.add(CLASS_NAME_COLLAPSING), this._element.classList.remove(CLASS_NAME_COLLAPSE, CLASS_NAME_SHOW$1);
      var n = this._triggerArray.length;
      if (n > 0) for (var i = 0; i < n; i++) {
        var o = this._triggerArray[i],
            r = getElementFromSelector(o);
        r && !r.classList.contains(CLASS_NAME_SHOW$1) && (o.classList.add(CLASS_NAME_COLLAPSED), o.setAttribute("aria-expanded", !1));
      }
...
var NAME$4 = "dropdown",
  ...
  return n.toggle = function () {
    ...
    if (!(this._element.disabled || this._element.classList.contains(CLASS_NAME_DISABLED) || this._menu.classList.contains(CLASS_NAME_SHOW$2))) {
      ...
      if (!EventHandler.trigger(this._element, EVENT_SHOW$1, n).defaultPrevented) {
        if (this._inNavbar) Manipulator.setDataAttribute(this._menu, "popper", "none");else {
          ...
          var i = this._element;
          "parent" === this._config.reference ? i = e : isElement(this._config.reference) ? (i = this._config.reference, void 0 !== this._config.reference.jquery && (i = this._config.reference[0])) : "object" == _typeof(this._config.reference) && (i = this._config.reference);
          ...
          this._popper = (0, Popper.createPopper)(i, this._menu, o), r && Manipulator.setDataAttribute(this._menu, "popper", "static");
        }
        var s;
        "ontouchstart" in document.documentElement && !e.closest(SELECTOR_NAVBAR_NAV) && (s = []).concat.apply(s, document.body.children).forEach(function (e) {
          return EventHandler.on(e, "mouseover", null, noop());
        }), this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.toggle(CLASS_NAME_SHOW$2), this._element.classList.toggle(CLASS_NAME_SHOW$2), EventHandler.trigger(this._element, EVENT_SHOWN$1, n);
      }
    }
  }, n.hide = function () {
    if (!this._element.disabled && !this._element.classList.contains(CLASS_NAME_DISABLED) && this._menu.classList.contains(CLASS_NAME_SHOW$2)) {
      ...
      EventHandler.trigger(this._element, EVENT_HIDE$1, e).defaultPrevented || (this._popper && this._popper.destroy(), this._menu.classList.toggle(CLASS_NAME_SHOW$2), this._element.classList.toggle(CLASS_NAME_SHOW$2), Manipulator.removeDataAttribute(this._menu, "popper"), EventHandler.trigger(this._element, EVENT_HIDDEN$1, e));
    }
  }, n.dispose = function () {
    ...
    if (e = _extends({}, this.constructor.Default, Manipulator.getDataAttributes(this._element), e), typeCheckConfig(NAME$4, e, this.constructor.DefaultType), "object" == _typeof(e.reference) && !isElement(e.reference) && "function" != typeof e.reference.getBoundingClientRect) throw new TypeError(NAME$4.toUpperCase() + ': Option "reference" provided type "object" without a required "getBoundingClientRect" method.');
    return e;
    ...
    return "static" === this._config.display && (e.modifiers = [{
      name: "applyStyles",
      enabled: !1
    }]), _extends({}, e, "function" == typeof this._config.popperConfig ? this._config.popperConfig(e) : this._config.popperConfig);
    ...
    if (!e || e.button !== RIGHT_MOUSE_BUTTON && ("keyup" !== e.type || e.key === TAB_KEY)) for (var t = SelectorEngine.find(SELECTOR_DATA_TOGGLE$2), n = 0, i = t.length; n < i; n++) {
      ...
      if (e && "click" === e.type && (r.clickEvent = e), o) {
        var s,
            a = o._menu;
        if (t[n].classList.contains(CLASS_NAME_SHOW$2) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && e.key === TAB_KEY) && a.contains(e.target) || EventHandler.trigger(t[n], EVENT_HIDE$1, r).defaultPrevented)) "ontouchstart" in document.documentElement && (s = []).concat.apply(s, document.body.children).forEach(function (e) {
          return EventHandler.off(e, "mouseover", null, noop());
        }), t[n].setAttribute("aria-expanded", "false"), o._popper && o._popper.destroy(), a.classList.remove(CLASS_NAME_SHOW$2), t[n].classList.remove(CLASS_NAME_SHOW$2), Manipulator.removeDataAttribute(a, "popper"), EventHandler.trigger(t[n], EVENT_HIDDEN$1, r);
      }
    }
    ...
    if (!(/input|textarea/i.test(e.target.tagName) ? e.key === SPACE_KEY || e.key !== ESCAPE_KEY && (e.key !== ARROW_DOWN_KEY && e.key !== ARROW_UP_KEY || e.target.closest(SELECTOR_MENU)) : !REGEXP_KEYDOWN.test(e.key)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !this.classList.contains(CLASS_NAME_DISABLED))) {
      ...
      } else (this.matches(SELECTOR_DATA_TOGGLE$2) ? this : SelectorEngine.prev(this, SELECTOR_DATA_TOGGLE$2)[0]).click();
    }
  }, _createClass(t, null, [{
    key: "Default",
    get: function get() {
...
var NAME$5 = "modal",
  ...
  return n.toggle = function (e) {
    ...
    if (e && e.preventDefault(), this._isShown && !this._isTransitioning && !EventHandler.trigger(this._element, EVENT_HIDE$2).defaultPrevented) {
      ...
      if (n && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), EventHandler.off(document, EVENT_FOCUSIN), this._element.classList.remove(CLASS_NAME_SHOW$3), EventHandler.off(this._element, EVENT_CLICK_DISMISS), EventHandler.off(this._dialog, EVENT_MOUSEDOWN_DISMISS), n) {
    ...
    if (n) {
      ...
      EventHandler.one(this._dialog, "transitionend", o), emulateTransitionEnd(this._dialog, r);
    } else o();
    ...
    if (this._isShown && this._config.backdrop) {
      ...
      }), n && reflow(this._backdrop), this._backdrop.classList.add(CLASS_NAME_SHOW$3), !n) return void e();
      var i = getTransitionDurationFromElement(this._backdrop);
      EventHandler.one(this._backdrop, "transitionend", e), emulateTransitionEnd(this._backdrop, i);
      ...
      if (this._element.classList.contains(CLASS_NAME_FADE$1)) {
        ...
        EventHandler.one(this._backdrop, "transitionend", o), emulateTransitionEnd(this._backdrop, r);
      } else o();
    } else e();
    ...
    if (!EventHandler.trigger(this._element, EVENT_HIDE_PREVENTED).defaultPrevented) {
      ...
      EventHandler.off(this._element, "transitionend"), EventHandler.one(this._element, "transitionend", function () {
        e._element.classList.remove(CLASS_NAME_STATIC), t || (EventHandler.one(e._element, "transitionend", function () {
    ...
    var e = this;
    this._isBodyOverflowing && (this._setElementAttributes(SELECTOR_FIXED_CONTENT, "paddingRight", function (t) {
    ...
    this._resetElementAttributes(SELECTOR_FIXED_CONTENT, "paddingRight"), this._resetElementAttributes(SELECTOR_STICKY_CONTENT, "marginRight"), this._resetElementAttributes("body", "paddingRight");
...
function sanitizeHtml(e, t, n) {
  ...
  for (var o = new window.DOMParser().parseFromString(e, "text/html"), r = Object.keys(t), s = (i = []).concat.apply(i, o.body.querySelectorAll("*")), a = function a(e, n) {
    var i,
        o = s[e],
...
var NAME$6 = "tooltip",
  ...
  return n.enable = function () {
    ...
    if (this._isEnabled) if (e) {
      ...
      if (this.getTipElement().classList.contains(CLASS_NAME_SHOW$4)) return void this._leave(null, this);
    ...
    if (this.isWithContent() && this._isEnabled) {
      ...
      if (!t.defaultPrevented && i) {
        ...
        o.setAttribute("id", r), this._element.setAttribute("aria-describedby", r), this.setContent(), this.config.animation && o.classList.add(CLASS_NAME_FADE$2);
        ...
        Data.setData(o, this.constructor.DATA_KEY, this), this._element.ownerDocument.documentElement.contains(this.tip) || l.appendChild(o), EventHandler.trigger(this._element, this.constructor.Event.INSERTED), this._popper = (0, Popper.createPopper)(this._element, o, this._getPopperConfig(a)), o.classList.add(CLASS_NAME_SHOW$4);

        var E,
            _,
            c = "function" == typeof this.config.customClass ? this.config.customClass() : this.config.customClass;

        c && (E = o.classList).add.apply(E, c.split(" ")), "ontouchstart" in document.documentElement && (_ = []).concat.apply(_, document.body.children).forEach(function (e) {
    ...
    if (this._popper) {
      ...
      if (!EventHandler.trigger(this._element, this.constructor.Event.HIDE).defaultPrevented) {
        ...
        if (t.classList.remove(CLASS_NAME_SHOW$4), "ontouchstart" in document.documentElement && (i = []).concat.apply(i, document.body.children).forEach(function (e) {
          return EventHandler.off(e, "mouseover", noop);
        }), this._activeTrigger[TRIGGER_CLICK] = !1, this._activeTrigger[TRIGGER_FOCUS] = !1, this._activeTrigger[TRIGGER_HOVER] = !1, this.tip.classList.contains(CLASS_NAME_FADE$2)) {
    ...
    this.setElementContent(SelectorEngine.findOne(SELECTOR_TOOLTIP_INNER, e), this.getTitle()), e.classList.remove(CLASS_NAME_FADE$2, CLASS_NAME_SHOW$4);
    ...
    return (t = t || Data.getData(e.delegateTarget, n)) || (t = new this.constructor(e.delegateTarget, this._getDelegateConfig()), Data.setData(e.delegateTarget, n, t)), t;
  }, n._getOffset = function () {
    var e = this,
    ...
    return _extends({}, n, "function" == typeof this.config.popperConfig ? this.config.popperConfig(n) : this.config.popperConfig);
...
var NAME$7 = "popover",
  ...
  return n.isWithContent = function () {
    ...
    "function" == typeof t && (t = t.call(this._element)), this.setElementContent(SelectorEngine.findOne(SELECTOR_CONTENT, e), t), e.classList.remove(CLASS_NAME_FADE$3, CLASS_NAME_SHOW$5);
  }, n._addAttachmentClass = function (e) {
...
var NAME$8 = "scrollspy",
  ...
  function t(t, n) {
    var i;
    return (i = e.call(this, t) || this)._scrollElement = "BODY" === t.tagName ? window : t, i._config = i._getConfig(n), i._selector = i._config.target + " " + SELECTOR_NAV_LINKS + ", " + i._config.target + " " + SELECTOR_LIST_ITEMS + ", " + i._config.target + " ." + CLASS_NAME_DROPDOWN_ITEM, i._offsets = [], i._targets = [], i._activeTarget = null, i._scrollHeight = 0, EventHandler.on(i._scrollElement, EVENT_SCROLL, function () {
      return i._process();
...
var NAME$9 = "tab",
  ...
  return n.show = function () {
    ...
    if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains(CLASS_NAME_ACTIVE$3) || this._element.classList.contains(CLASS_NAME_DISABLED$1))) {
      ...
      var r = t ? EventHandler.trigger(t, EVENT_HIDE$3, {
        relatedTarget: this._element
      }) : null;
    ...
    if (o && r) {
      ...
      o.classList.remove(CLASS_NAME_SHOW$6), EventHandler.one(o, "transitionend", s), emulateTransitionEnd(o, a);
    } else s();
    ...
    e.classList.add(CLASS_NAME_ACTIVE$3), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), reflow(e), e.classList.contains(CLASS_NAME_FADE$4) && e.classList.add(CLASS_NAME_SHOW$6), e.parentNode && e.parentNode.classList.contains(CLASS_NAME_DROPDOWN_MENU) && (e.closest(SELECTOR_DROPDOWN$1) && SelectorEngine.find(SELECTOR_DROPDOWN_TOGGLE$1).forEach(function (e) {
...
var NAME$a = "toast",
  ...
  return n.show = function () {
    ...
    if (!EventHandler.trigger(this._element, EVENT_SHOW$4).defaultPrevented) {
      this._clearTimeout(), this._config.animation && this._element.classList.add(CLASS_NAME_FADE$5);

      var t = function t() {
        e._element.classList.remove(CLASS_NAME_SHOWING), e._element.classList.add(CLASS_NAME_SHOW$7), EventHandler.trigger(e._element, EVENT_SHOWN$4), e._config.autohide && (e._timeout = setTimeout(function () {
          e.hide();
        }, e._config.delay));
      };
      ...
      if (this._element.classList.remove(CLASS_NAME_HIDE), reflow(this._element), this._element.classList.add(CLASS_NAME_SHOWING), this._config.animation) {
        ...
        EventHandler.one(this._element, "transitionend", t), emulateTransitionEnd(this._element, n);
      } else t();
    }
  }, n.hide = function () {
    var e = this;

    if (this._element.classList.contains(CLASS_NAME_SHOW$7) && !EventHandler.trigger(this._element, EVENT_HIDE$4).defaultPrevented) {
      var t = function t() {
    ...
    this._clearTimeout(), this._element.classList.contains(CLASS_NAME_SHOW$7) && this._element.classList.remove(CLASS_NAME_SHOW$7), EventHandler.off(this._element, EVENT_CLICK_DISMISS$1), e.prototype.dispose.call(this), this._config = null;
  }, n._getConfig = function (e) {
